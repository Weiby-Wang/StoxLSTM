...
class xLSTMBlockStackConfig:
    ...
    def _create_block_map(self) -> str:
        ...
        print('xLSTM block map: ', block_map_str)
...
class xLSTMBlockStack(nn.Module):
    ...
    def _create_blocks(self, config: xLSTMBlockStackConfig):
        ...
        blocks = []
        for block_idx, block_type_int in enumerate(config.block_map): #block_type_int [0, 1, 0, 0, 0, 0, 0]
            if block_type_int == 0: #mLSTM
