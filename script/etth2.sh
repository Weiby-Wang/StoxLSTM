...
python -u main.py \
    ...
    --wts_save_path ./_wts/${data}/${data}_96.ckpt > ./train_info/${data}/${data}_96.log 2>&1
...
python -u main.py \
    ...
    --wts_save_path ./_wts/${data}/${data}_192.ckpt > ./train_info/${data}/${data}_192.log 2>&1
...
python -u main.py \
    ...
    --wts_save_path ./_wts/${data}/${data}_336.ckpt > ./train_info/${data}/${data}_336.log 2>&1
...
python -u main.py \
    ...
    --wts_save_path ./_wts/${data}/${data}_720.ckpt > ./train_info/${data}/${data}_720.log 2>&1